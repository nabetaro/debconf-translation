...
Description-es: No mostrar preguntas con una prioridad menor que...
 Los paquetes que usan debconf para la configuración le asignan una
 ...
 Puede escoger la prioridad más baja para las preguntas que desea ver:
   ...
   - 'baja' es para asuntos triviales, que tienen valores predeterminados
     que funcionarán en la inmensa mayoría de casos.
 .
 Por ejemplo, esta pregunta es de prioridad media, y si el valor escogido
 para la prioridad fuese 'alta' o 'crítica', no hubiese visto esta
 pregunta.
 .
 Si es un principiante en el sistema Debian GNU/Linux, escoja 'crítica' por
 ahora, para ver únicamente las preguntas más importantes.
...
Description-es: ¿Qué interfaz quiere usar para configurar paquetes?
 Los paquetes que usan debconf para configurarse comparten un aspecto
 común. Puede elegir el tipo de interfaz de usuario que quiere que usen.
 .
